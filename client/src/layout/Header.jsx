...
const Header = () => {
  ...
  // Grouped state for a single re-render per tick
  ...
  return (
    <header className="flex items-center justify-between px-8 py-4 border-b border-gray-100 sticky top-0 z-50 backdrop-blur-md bg-white/80 shadow-sm transition-all duration-300">
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center gap-4 border-l border-gray-100 pl-6">
            ...
            <div className="relative group cursor-pointer">
                <div className="w-10 h-10 rounded-full bg-[#faf9f6] border border-gray-200 flex items-center justify-center shadow-sm group-hover:border-orange-500 transition-all overflow-hidden">
                    {user?.avatar?.url ? (
