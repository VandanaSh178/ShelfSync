    ...
    <div className="flex min-h-screen bg-[#FDFDFD]">
      <div className="hidden lg:flex w-1/2 bg-black relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          <img src={logo_with_title} alt="ShelfSync" className="w-56 mx-auto mb-10 brightness-0 invert" />
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 md:p-16">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div>
              <label className="block text-[10px] uppercase tracking-widest text-gray-400 font-bold mb-2 ml-1">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  emailRef.current = e.target.value; // ✅ always in sync
                }}
          ...
          <footer className="mt-12 text-center lg:text-left">
            <p className="text-gray-400 text-xs">
              ...
              <span className="text-gray-900 underline cursor-pointer">Terms of Service</span>.
            </p>
